...
const BloodlinesEducation: React.FC = () => {
  return (
    <div className={styles.container}>
      ...
      <section className={styles.detailedProfiles}>
        ...
        <ul>
          <li>
            <Link href="/bloodlines-education/profile1">
              <a>Bloodline Profile 1</a>
            </Link>
          </li>
          <li>
            <Link href="/bloodlines-education/profile2">
              <a>Bloodline Profile 2</a>
            </Link>
          </li>
          <li>
            <Link href="/bloodlines-education/profile3">
              <a>Bloodline Profile 3</a>
            </Link>
          </li>
        </ul>
      </section>
      ...
      <section className={styles.topics}>
        ...
        <ul>
          <li>
            <Link href="/bloodlines-education/concept1">
              <a>Concept 1</a>
            </Link>
          </li>
          <li>
            <Link href="/bloodlines-education/concept2">
              <a>Concept 2</a>
            </Link>
          </li>
          <li>
            <Link href="/bloodlines-education/concept3">
              <a>Concept 3</a>
            </Link>
          </li>
        </ul>
